...
MODEL_PATH = rf"{OUTPUTS_DIR}\models\best_video_efficientnet_lstm_final.pth"

RESULTS_DIR = rf"{OUTPUTS_DIR}\results\video_efficientnet_lstm_final"

PLOTS_DIR = rf"{OUTPUTS_DIR}\plots\video_efficientnet_lstm_final"
...
print("🔥 VIDEO EFFICIENTNET-LSTM RESULTS")
...
plt.title("EfficientNet-LSTM Confusion Matrix")
