...
MODEL_PATH = rf"{OUTPUTS_DIR}\models\best_video_efficientnet_lstm_v2.pth"

RESULTS_DIR = rf"{OUTPUTS_DIR}\results\video_efficientnet_lstm_v2"

PLOTS_DIR = rf"{OUTPUTS_DIR}\plots\video_efficientnet_lstm_v2"
...
print("🔥 VIDEO EFFICIENTNET-LSTM V2 RESULTS")
...
plt.title(
    "EfficientNet-LSTM V2 Confusion Matrix"
)
